    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) border-sidebar-border bg-sidebar p-0 text-sidebar-foreground [&_[data-slot=sheet-close]]:bg-sidebar-accent [&_[data-slot=sheet-close]]:text-sidebar-accent-foreground [&_[data-slot=sheet-close]]:hover:bg-sidebar-foreground/10"
          style={
            {
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>
              Menampilkan menu samping di layar kecil.
            </SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <SidebarIcon />
      <span className="sr-only">Buka atau tutup menu samping</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      title="Buka atau tutup menu samping"
      className={cn(
